            ...
            <div className="mx-auto relative w-full max-w-3xl flex justify-center">
                ...
                >
                    <p className="text-[#301733] text-base md:text-lg leading-relaxed overflow-y-auto max-h-[400px] pr-2">
                        Happy Birthday, Kintu maa! You deserve all the happiness, love, and smiles in the world today and always.
                        You have this special way of making everything around you brighter, your smile, your kindness, and the way
                        you make me feel truly amazing and i thing the rarest wife i got . I hope your day is filled with laughter, surprises, and moments that
                        ...
                        <br></br>Keep being the amazing person you are, spreading joy wherever you go. Wishing you endless happiness,
                        I hope your birthday is an unforgettable day filled wiht love and joy.💗
                        <br></br>I Love You So Muchhhhhh.💗
                    </p>
                </motion.div>
            </div>
        </div>
